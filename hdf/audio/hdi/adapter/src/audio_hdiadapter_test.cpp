...
HWTEST_F(AudioHdiAdapterTest, SUB_Audio_HDI_GetAllAdapters_0005, Function | MediumTest | Level1)
{
    int32_t ret = -1;
    int *size = nullptr;
    struct AudioAdapterDescriptor *descs = nullptr;
...
*/
#ifdef AUDIO_ADM_SERVICE
HWTEST_F(AudioHdiAdapterTest, SUB_Audio_HDI_LoadAdapter_0007, Function | MediumTest | Level1)
{
    int32_t ret = -1;
    int size = 0;
    struct AudioAdapterDescriptor *descs = nullptr;
