...
*/
HWTEST_F(AudioHdiCaptureTest, SUB_Audio_HDI_AudioCaptureGetCapturePosition_0011, Function | MediumTest | Level1)
{
    int32_t ret = -1;
    struct AudioCapture *capture = nullptr;
    struct AudioAdapter *adapter = nullptr;
...
*/
HWTEST_F(AudioHdiCaptureTest, SUB_Audio_HDI_AudioCaptureGetCapturePosition_0012, Function | MediumTest | Level1)
{
    int32_t ret = -1;
    uint64_t channelCountExp = 1;
    uint32_t sampleRateExp = 48000;
...
* @tc.desc  Test GetMmapPosition interface,return 0 if Getting position successfully.
*/
HWTEST_F(AudioHdiCaptureTest, SUB_Audio_HDI_CaptureGetMmapPosition_0002, Function | MediumTest | Level1)
{
    int32_t ret = -1;
    uint64_t frames = 0;
    int64_t timeExp = 0;
