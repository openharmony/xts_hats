...
/* capture frame cases */
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0100, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0200, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0300, TestSize.Level1)
{
    uint64_t frames;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0400, TestSize.Level1)
{
    int32_t ret;
    uint64_t frames;
    struct AudioTimeStamp time;
...
/* capture start cases */
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0500, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0600, TestSize.Level1)
{
    ASSERT_NE(capture_->Start, nullptr);
...
/* capture stop cases */
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0700, TestSize.Level1)
{
    ASSERT_NE(capture_->Start, nullptr);
...
/* capture pause cases */
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_0900, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1000, TestSize.Level1)
{
    ASSERT_NE(capture_->Pause, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1100, TestSize.Level1)
{
    ASSERT_NE(capture_->Pause, nullptr);
    ASSERT_NE(capture_->Start, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1200, TestSize.Level1)
{
    ASSERT_NE(capture_->Pause, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1300, TestSize.Level1)
{
    ASSERT_NE(capture_->Resume, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1400, TestSize.Level1)
{
    ASSERT_NE(capture_->Resume, nullptr);
...
/* capture flush cases */
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1500, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1600, TestSize.Level1)
{
    ASSERT_NE(capture_->Flush, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1700, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1800, TestSize.Level1)
{
    ASSERT_NE(capture_->TurnStandbyMode, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_1900, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2000, TestSize.Level1)
{
    ASSERT_NE(capture_->AudioDevDump, nullptr);
    int32_t range = 4;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2100, TestSize.Level1)
{
...
// set twice
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2200, TestSize.Level1)
{
    bool isSupport = true;
    ASSERT_NE(capture_->SetMute, nullptr);
    ASSERT_NE(capture_->GetMute, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2300, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2400, TestSize.Level1)
{
    bool isSupport = true;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2500, TestSize.Level1)
{
    EXPECT_NE(capture_->GetMute, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2600, TestSize.Level1)
{
    float volume = 0.0;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2700, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2800, TestSize.Level1)
{
    EXPECT_NE(capture_->SetVolume, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_2900, TestSize.Level1)
{
    float volume = 0.0;
    EXPECT_NE(capture_->GetVolume, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3000, TestSize.Level1)
{
    float volume = 0.0;
    EXPECT_NE(capture_->GetVolume, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3100, TestSize.Level1)
{
    float bottom = 0;
    float top = 0;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3200, TestSize.Level1)
{
    float bottom = 0;
    float top = 0;
    EXPECT_NE(capture_->GetGainThreshold, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3300, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3400, TestSize.Level1)
{
    EXPECT_NE(capture_->SetGain, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3500, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3600, TestSize.Level1)
{
    EXPECT_NE(capture_->SetGain, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3700, TestSize.Level1)
{
    struct AudioSampleAttributes attrs = {};
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3800, TestSize.Level1)
{
    struct AudioSampleAttributes attrs = {};
    EXPECT_NE(capture_->GetSampleAttributes, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_3900, TestSize.Level1)
{
    struct AudioSampleAttributes attrs = {
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4000, TestSize.Level1)
{
    int32_t ret = HDF_SUCCESS;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4200, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4300, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4400, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4500, TestSize.Level1)
{
    ASSERT_NE(capture_->GetExtraParams, nullptr);
    char keyValueListReply[256] = {};
    uint32_t listLenth = 256;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4600, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4700, TestSize.Level1)
{
    ASSERT_NE(capture_->SelectScene, nullptr);
    struct AudioSceneDescriptor sceneDesc = {};
    sceneDesc.scene.id = AUDIO_IN_CALL;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_4800, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5000, TestSize.Level1)
{
    ASSERT_NE(capture_->GetVersion, nullptr);
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5100, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5200, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5300, TestSize.Level1)
{
    ASSERT_NE(capture_->GetFrameBufferSize, nullptr);
    uint64_t bufferSize = 0;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5400, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5500, TestSize.Level1)
{
    ASSERT_NE(capture_->AddAudioEffect, nullptr);
    uint64_t effectId = -1;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5600, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5700, TestSize.Level1)
{
    ASSERT_NE(capture_->RemoveAudioEffect, nullptr);
    uint64_t effectId = -1;
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5800, TestSize.Level1)
{
...
HWTEST_F(AudioUtCaptureTest, SUB_Driver_Audio_CaptureHdi_5900, TestSize.Level1)
{
    ASSERT_NE(capture_->CheckSceneCapability, nullptr);
    struct AudioSceneDescriptor sceneDesc = {};
    sceneDesc.scene.id = AUDIO_IN_COMMUNICATION;
