 ...
 */
#include "camera_metadata_enum_test.h"
...
HWTEST_F(CameraMetadataEnumTest, Camera_Metedate_Enum_001, TestSize.Level1)
{
    ...
    for (int32_t i = 0; i < operationMode.size(); i++) {
        switch (operationMode[i]) {
            case 16 : {
                printf("OHOS::HDI::Camera::V1_3::OperationMode::QUICK_SHOT_PHOTO is here\n");
                break;
            }
            case 19 : {
                printf("OHOS::HDI::Camera::V1_3::OperationMode::TIMELAPSE_PHOTO is here\n");
                break;
            }
            case 21 : {
                printf("OHOS::HDI::Camera::V1_3::OperationMode::FLUORESCENCE_PHOTO is here\n");
                break;
            }
        }
    }
...
HWTEST_F(CameraMetadataEnumTest, Camera_Metedate_Enum_004, TestSize.Level1)
{
    ...
    for (int32_t i = 0; i < errorCode.size(); i++) {
        switch (errorCode[i]) {
            ...
            case 2: {
                printf("OHOS::HDI::Camera::V1_3::ErrorCode::ERROR_TIMEOUT is here\n");
                break;
            }
            case 3: {
...
HWTEST_F(CameraMetadataEnumTest, Camera_Metedate_Enum_006, TestSize.Level1)
{
    ...
    for (int32_t i = 0; i < streamyType.size(); i++) {
        switch (streamyType[i]) {
            ...
            case 3: {
                printf("OHOS::HDI::Camera::V1_3::StreamType::STREAM_TYPE_POST_VIEW is here\n");
                break;
            }
            case 4: {
                printf("OHOS::HDI::Camera::V1_3::StreamType::STREAM_TYPE_ANALYZE is here\n");
                break;
            }
            case 5: {
