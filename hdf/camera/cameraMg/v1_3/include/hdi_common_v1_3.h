...
public:
    ...
    void CreateAndCommitStreamsForHighFrameRate(std::shared_ptr<OHOS::Camera::Test> cameraTest);
    void CreateAndCommitStreamsForSlowMotion(std::shared_ptr<OHOS::Camera::Test> cameraTest);
    void UpdateSettingsForSlowMotionMode(std::shared_ptr<OHOS::Camera::Test> cameraTest);
    void SuperSlowMotionStatusCallback(std::shared_ptr<OHOS::Camera::Test> cameraTest);
    void startStreamForHighResolutionPhoto(std::shared_ptr<OHOS::Camera::Test> cameraTest);
    ...
    OHOS::sptr<OHOS::HDI::Camera::V1_2::IStreamOperator> streamOperator_V1_3 = nullptr;
