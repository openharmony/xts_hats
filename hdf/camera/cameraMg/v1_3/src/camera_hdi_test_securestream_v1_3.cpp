...
#include "camera_hdi_test_securestream_v1_3.h"
#include <functional>
...
void CameraHdiTestSecureStreamV1_3::SetUpTestCase(void) {}
void CameraHdiTestSecureStreamV1_3::TearDownTestCase(void) {}
void CameraHdiTestSecureStreamV1_3::SetUp(void)
{
    cameraTest = std::make_shared<OHOS::Camera::Test>();
    cameraTest->Init(); // assert inside
}

void CameraHdiTestSecureStreamV1_3::TearDown(void)
{
    cameraTest->Close();
}

/**
 * @tc.name: SUB_Driver_Camera_SecureStream_0200
 * @tc.desc: invoke Secure stream
 * @tc.size: MediumTest
 * @tc.type: Function
 */
HWTEST_F(CameraHdiTestSecureStreamV1_3, SUB_Driver_Camera_SecureStream_0200, TestSize.Level1)
{
    cameraTest->OpenSecureCamera(DEVICE_1);
    // PREVIEW stream
...
/**
 * @tc.name: SUB_Driver_Camera_SecureStream_0300
 * @tc.desc: invoke GetSecureCameraSeq, verification
 * @tc.size: MediumTest
 * @tc.type: Function
 */
HWTEST_F(CameraHdiTestSecureStreamV1_3, SUB_Driver_Camera_SecureStream_0300, TestSize.Level1)
{
    cameraTest->OpenSecureCamera(DEVICE_1);
