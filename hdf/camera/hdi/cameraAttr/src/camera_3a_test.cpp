...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0001, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，then UpdateSettings ";
    std::cout <<"OHOS_CONTROL_AE_EXPOSURE_COMPENSATION, success." << std::endl;
    // Start stream
    ...
    std::cout << "==========[test log]UpdateSettings, exposure for 1s." << std::endl;
    sleep(1);
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0002, Function | MediumTest | Level1)
{
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_INCANDESCENT, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0003, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_INCANDESCENT, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_FLUORESCENT, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0004, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_FLUORESCENT, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_WARM_FLUORESCENT, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0005, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_WARM_FLUORESCENT, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_DAYLIGHT, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0006, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview, updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_DAYLIGHT, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_CLOUDY_DAYLIGHT, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0007, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_CLOUDY_DAYLIGHT, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_TWILIGHT, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0008, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_TWILIGHT, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  * @tc.name: updateSettings AWB
  * @tc.desc: Preview，updateSettings OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_SHADE, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0009, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
    std::cout <<"OHOS_CONTROL_AWB_MODE-OHOS_CAMERA_AWB_MODE_SHADE, success." << std::endl;
    // Start stream
    Test_->intents = {Camera::PREVIEW};
    Test_->StartStream(Test_->intents);
    // Get preview
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0010, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Preview，updateSettings ";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0020, Function | MediumTest | Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0030, Function | MediumTest | Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0031, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0040, Function | MediumTest | Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(Camera3ATest, Camera_3a_0041, Function | MediumTest | Level2)
{
