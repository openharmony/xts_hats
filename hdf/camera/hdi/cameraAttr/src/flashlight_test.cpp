...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(FlashlightTest, Camera_Flashlight_0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(FlashlightTest, Camera_Flashlight_0002, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(FlashlightTest, Camera_Flashlight_0003, Function | MediumTest | Level3)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(FlashlightTest, Camera_Flashlight_0010, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(FlashlightTest, Camera_Flashlight_0011, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]Open the camera, preview, then turn on the flashlight,";
    std::cout <<" expected return errorcode." << std::endl;
    Test_->Open();
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(FlashlightTest, Camera_Flashlight_0020, Function | MediumTest | Level1)
{
