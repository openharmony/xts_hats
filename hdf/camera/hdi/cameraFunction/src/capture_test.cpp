...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0002, Function | MediumTest | Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0003, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0004, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0005, Function | MediumTest | Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0006, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0007, Function | MediumTest | Level1)
{
    std::cout << "==========[test log]check Capture: Commit 2 streams together,";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0010, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0030, Function | MediumTest | Level2)
{
    std::cout << "==========[test log]check Capture: Preview and still_capture streams,";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(CaptureTest, Camera_Capture_0040, Function | MediumTest | Level2)
{
    std::cout << "==========[test log]check Capture: Preview and still_capture streams + 3A,";
    std::cout << " Commit 2 streams together, capture together, isStreaming is true." << std::endl;
    // Configure two streams of information
