...
/**
  ...
  */
BENCHMARK_F(DisplayBenchmarkTest, GetDisplayCompChange)(benchmark::State &state)
{
    int32_t ret;
...
BENCHMARK_REGISTER_F(DisplayBenchmarkTest, GetDisplayCompChange)->
    Iterations(30)->Repetitions(3)->ReportAggregatesOnly();
...
/**
  ...
  */
BENCHMARK_F(DisplayBenchmarkTest, GetDisplayReleaseFence)(benchmark::State &state)
{
    int32_t ret;
    std::vector<uint32_t> layers {};
...
BENCHMARK_REGISTER_F(DisplayBenchmarkTest, GetDisplayReleaseFence)->
    Iterations(30)->Repetitions(3)->ReportAggregatesOnly();
