...
int32_t GeofenceCallbackImpl::ReportGeofenceEvent(int32_t fenceIndex, const LocationInfo &location, int32_t event,
                                                  int64_t timestamp)
{
    (void)fenceIndex;
    (void)location;
