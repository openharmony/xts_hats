...
class HdfSensorHdiServiceTest : public testing::Test {
public:
...
void HdfSensorHdiServiceTest::SetUpTestCase()
{
    g_sensorInterface = ISensorInterface::Get();
}

void HdfSensorHdiServiceTest::TearDownTestCase()
{
}

void HdfSensorHdiServiceTest::SetUp()
{
}

void HdfSensorHdiServiceTest::TearDown()
{
}
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, GetSensorClient0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, GetSensorList0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, EnableSensor0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, EnableSensor0002, Function | MediumTest | Level1)
{
    std::vector<HdfSensorInformation> info;
    int32_t ret = g_sensorInterface->GetAllSensorInfo(info);
    EXPECT_EQ(0, ret);
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, SetSensorBatch0001, Function | MediumTest | Level1)
{
    std::vector<HdfSensorInformation> info;
    int32_t ret = g_sensorInterface->GetAllSensorInfo(info);
    EXPECT_EQ(0, ret);
...
/** @tc.name: SetSensorBatch0002
    ...
    @tc.type: FUNC
    */
HWTEST_F(HdfSensorHdiServiceTest, SetSensorBatch0002, Function | MediumTest | Level1)
{
    std::vector<HdfSensorInformation> info;
    int32_t ret = g_sensorInterface->GetAllSensorInfo(info);
    EXPECT_EQ(0, ret);
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, SetSensorMode0001, Function | MediumTest | Level1)
{
    std::vector<HdfSensorInformation> info;
    int32_t ret = g_sensorInterface->GetAllSensorInfo(info);
    EXPECT_EQ(0, ret);
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, SetSensorMode0002, Function | MediumTest | Level1)
{
    std::vector<HdfSensorInformation> info;
    int32_t ret = g_sensorInterface->GetAllSensorInfo(info);
    EXPECT_EQ(0, ret);
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HdfSensorHdiServiceTest, SetSensorOption0001, Function | MediumTest | Level1)
{
    std::vector<HdfSensorInformation> info;
    int32_t ret = g_sensorInterface->GetAllSensorInfo(info);
    EXPECT_EQ(0, ret);
