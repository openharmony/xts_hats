...
namespace {
     ...
     * @tc.desc: Two threads deliver one sensor respectively.
     * @tc.type: FUNC
     * @tc.size: MediumTest
     */
     ...
     * @tc.desc: Two threads deliver Two sensor respectively.
     * @tc.type: FUNC
     * @tc.size: MediumTest
     */
     ...
     * @tc.desc: Five threads deliver two unique sensors.
     * @tc.type: FUNC
     * @tc.size: MediumTest
     */
     ...
     * @tc.desc: Ten threads, each thread calls four sensors that can be repeated.
     * @tc.type: FUNC
     * @tc.size: MediumTest
     */
