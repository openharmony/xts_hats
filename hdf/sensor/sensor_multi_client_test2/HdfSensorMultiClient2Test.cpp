...
class HatsHdfSensorMultiClientTest2 : public testing::Test {
public:
...
void HatsHdfSensorMultiClientTest2::SetUpTestCase()
{
...
void HatsHdfSensorMultiClientTest2::TearDownTestCase()
{
}

void HatsHdfSensorMultiClientTest2::SetUp()
{
    if (g_sensorInterface == nullptr) {
...
void HatsHdfSensorMultiClientTest2::TearDown()
{
}
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HatsHdfSensorMultiClientTest2, SUB_Driver_Sensor_HdiSensor_0100, TestSize.Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HatsHdfSensorMultiClientTest2, SUB_Driver_Sensor_HdiSensor_0200, TestSize.Level1)
{
    if (g_info.size() > 0) {
        ...
        ret = g_sensorInterface->SetBatch(deviceSensorInfo, 50000000, 0);
        EXPECT_EQ(0, ret);
        printf("SetBatch samplingInterval is 50000000\n");
