...
class HatsHdfSensorMultiClientTest3 : public testing::Test {
public:
...
void HatsHdfSensorMultiClientTest3::SetUpTestCase()
{
...
void HatsHdfSensorMultiClientTest3::TearDownTestCase()
{
}

void HatsHdfSensorMultiClientTest3::SetUp()
{
    if (g_sensorInterface == nullptr) {
...
void HatsHdfSensorMultiClientTest3::TearDown()
{
}
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HatsHdfSensorMultiClientTest3, SUB_Driver_Sensor_HdiSensor_0100, TestSize.Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(HatsHdfSensorMultiClientTest3, SUB_Driver_Sensor_HdiSensor_0200, TestSize.Level1)
{
    if (g_info.size() > 0) {
        ...
        ret = g_sensorInterface->SetBatch(deviceSensorInfo, 10000000, 0);
        EXPECT_EQ(0, ret);
        printf("SetBatch samplingInterval is 10000000\n");
