...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8000
...
HWTEST_F(UsbdDeviceStatusTest, UsbdGetDeviceSpeed002, Function | MediumTest | Level1)
{
    ...
    uint8_t speed = 0;
    auto ret = g_usbHostInterface->GetDeviceSpeed(dev, speed);
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8100
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8200
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8300
...
HWTEST_F(UsbdDeviceStatusTest, UsbdGetInterfaceActiveStatus002, Function | MediumTest | Level1)
{
    ...
    dev.busNum = BUS_NUM_INVALID;
    bool unactived = 1;
    auto ret = g_usbHostInterface->GetInterfaceActiveStatus(dev, interfaceId, unactived);
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8400
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8500
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8600
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8700
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8800
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_8900
...
HWTEST_F(UsbdDeviceStatusTest, UsbdClearHalt001, Function | MediumTest | Level1)
{
    ...
    ret = g_usbHostInterface->ClearHalt(dev, pipe);
