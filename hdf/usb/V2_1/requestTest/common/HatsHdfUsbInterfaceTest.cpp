...
void UsbdInterfaceTest::SetUpTestCase(void)
{
    ...
    ret = g_usbHostInterface->ClaimInterface(dev_, 1, 1);
    ASSERT_EQ(0, ret);
}
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Func_0900
...
HWTEST_F(UsbdInterfaceTest, SUB_USB_HostManager_HDI_Func_0900, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbHostInterface->SetInterface(dev, interfaceId, altIndex);
    HDF_LOGI("UsbdInterfaceTest::SUB_USB_HostManager_HDI_Func_0900 %{public}d ret=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}

/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_4700\
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_4800
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_4900
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_5000
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_5100
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_5200
...
/**
 * @tc.number: SUB_USB_HostManager_HDI_Compatibility_5300
