...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0450, Function | MediumTest | Level1)
{
    ...
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0450 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0460, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000000, 8, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0460 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0470, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000000, 8, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0470 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0480, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0480 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0490, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000000, 6, 0x100, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0490 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0500, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000000, 6, 0x100, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0500 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0510, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0510 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0520, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000001, 0X0A, 0, intercafeidex, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0520 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0530, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000001, 0X0A, 0, intercafeidex, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0530 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0540, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0540 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0550, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000000, 0, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0550 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0560, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000000, 0, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0560 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0570, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0570 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0580, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000001, 0, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0580 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0590, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000001, 0, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0590 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0600, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0600 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0610, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000010, 0, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0610 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0620, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000010, 0, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0620 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0630, Function | MediumTest | Level1)
{
    ...
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0630 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0640, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000010, 0X0C, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0640 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
...
HWTEST_F(UsbdTransferTest, SUB_USB_HDI_0650, Function | MediumTest | Level1)
{
    ...
    struct UsbCtrlTransfer ctrlparmas = { 0b10000010, 0X0C, 0, 0, 1000 };
    auto ret = g_usbInterface->ControlTransferRead(dev, ctrlparmas, bufferdata);
    HDF_LOGI("UsbdTransferTest::SUB_USB_HDI_0650 %{public}d ControlTransferRead=%{public}d", __LINE__, ret);
    ASSERT_NE(ret, 0);
}
