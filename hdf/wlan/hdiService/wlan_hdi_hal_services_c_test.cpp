 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdfWifiServiceCTest, RegisterEventCallbackTest_015, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdfWifiServiceCTest, ResetDriverTest_016, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdfWifiServiceCTest, StartScanTest_017, Function | MediumTest | Level1)
{
    int32_t rc;
    const int32_t wlan_type = PROTOCOL_80211_IFTYPE_STATION;
    struct WlanFeatureInfo *ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdfWifiServiceCTest, UnregisterEventCallbackTest_018, Function | MediumTest | Level1)
{
