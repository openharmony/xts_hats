 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetSupportFeatureComboTest_001, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, CreateFeatureTest_002, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetFeatureByIfNameTest_003, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetAsscociatedStasTest_004, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
    std::shared_ptr<WifiFeatureInfo> ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, SetCountryCodeTest_005, Function | MediumTest | Level1)
{
    std::string code = "CN";
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
    std::shared_ptr<WifiFeatureInfo> ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetNetworkIfaceNameTest_006, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
    std::shared_ptr<WifiFeatureInfo> ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetFeatureTypeTest_007, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
    std::shared_ptr<WifiFeatureInfo> ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, SetMacAddressTest_008, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetDeviceMacAddressTest_009, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
    std::shared_ptr<WifiFeatureInfo> ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetFreqsWithBandTest_010, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
    std::shared_ptr<WifiFeatureInfo> ifeature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, SetTxPowerTest_011, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_AP;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, GetChipIdTest_012, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, SetScanningMacAddressTest_013, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_STATION;
    std::shared_ptr<WifiFeatureInfo> feature = nullptr;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, RegisterEventCallbackTest_014, Function | MediumTest | Level1)
{
    auto wlanObj = IWlan::Get(WLAN_SERVICE_NAME);
    ASSERT_TRUE(wlanObj != nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, UnregisterEventCallbackTest_015, Function | MediumTest | Level1)
{
    auto wlanObj = IWlan::Get(WLAN_SERVICE_NAME);
    ASSERT_TRUE(wlanObj != nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WifiHdiHalServiceTest, ResetDriverTest_016, Function | MediumTest | Level1)
{
    int32_t wlan_type = PROTOCOL_80211_IFTYPE_STATION;
    std::shared_ptr<WifiFeatureInfo> feature = nullptr;
    uint8_t chipId= 0;
