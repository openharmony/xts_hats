...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(WiFiModuleTest, SUB_WLAN_MODULE_Create_0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(WiFiModuleTest, SUB_WLAN_MODULE_AddFeature_0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(WiFiModuleTest, SUB_WLAN_MODULE_DeleteFeature_0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(WiFiModuleTest, SUB_WLAN_MODULE_Delete_0001, Function | MediumTest | Level1)
{
