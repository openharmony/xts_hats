...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(WiFiNetBuffTest, SUB_WLAN_NET_BUFF_0001, Function | MediumTest | Level1)
{
...
/**
  ...
  * @tc.type: FUNC
  */
HWTEST_F(WiFiNetBuffTest, SUB_WLAN_NET_BUFF_Queue_0001, Function | MediumTest | Level1)
{
