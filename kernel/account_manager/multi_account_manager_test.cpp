...
const int PROC1_PID_VALUE = 1001;
const int PROC2_PID_VALUE = 1002;
const int PROC3_PID_VALUE = 1003;
const int PROC4_PID_VALUE = 1004;
/*
 * @tc.number SET_ACCOUNT_PRORITY_0100
 * @tc.name Test set account prority
...
/*
 * @tc.number RECALC_BUNDLE_PRORITY_0100
 * @tc.name Test recalc bundle prority
 * @tc.desc [C- SOFTWARE -0200]
*/
...
/*
 * @tc.number ACCOUNT_COLD_SWITCH_0100
 * @tc.name Test account cold switch
 * @tc.desc [C- SOFTWARE -0200]
*/
HWTEST_F(MultiAccountManagerTest, AccountColdSwitch, TestSize.Level1)
{
    ...
    ProcessPriorityInfo proc1(PROC1_PID_VALUE, bundle->uid_, bundle->priority_);
    ProcessPriorityInfo proc2(PROC2_PID_VALUE, bundle->uid_, bundle->priority_);
    ProcessPriorityInfo proc3(PROC3_PID_VALUE, bundle->uid_, bundle->priority_);
    ProcessPriorityInfo proc4(PROC4_PID_VALUE, bundle->uid_, bundle->priority_);
...
/*
 * @tc.number ACCOUNT_HOT_SWITCH_0100
 * @tc.name Test account hot switch
 * @tc.desc [C- SOFTWARE -0200]
*/
