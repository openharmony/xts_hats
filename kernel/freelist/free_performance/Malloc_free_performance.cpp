...
const int SIZE_ARR_SIZE = 2048;
const int NANOSEC_PER_SEC = 1e9;
const int MALLOC_TIME = 131072;

using namespace testing::ext;
using namespace std;

class MallocFreePerformance : public testing::Test {
public:
...
void MallocFreePerformance::SetUp()
{
}
void MallocFreePerformance::TearDown()
{
}
void MallocFreePerformance::SetUpTestCase()
{
}
void MallocFreePerformance::TearDownTestCase()
{
}
...
*/
HWTEST_F(MallocFreePerformance, freeperformance0100, Function | MediumTest | Level1)
{
    cpu_set_t mask;
    ...
    ASSERT_TRUE(gettime <= 1) << "Performance not up to standard";
}
