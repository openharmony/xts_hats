...
static int io_uring_setup(unsigned entries, struct io_uring_params *p) {
    return syscall(__NR_io_uring__setup, entries, p);
}
...
HWTEST_F(HatsEnterTest, EnterSqeInvalidStatxFailed_0008, Function | MediumTest | Level2)
{
    ...
    struct io_uring_cqes *cqes = (struct io_uring_cqes *)((char *)cq_ptr + p.cq_off_cqes);
 ...
 * @tc.level  : Level 1
 */
HWTEST_F(HatsEnterTest, SpliceMoveFileDataToPipeSuccess_0002, Function | MediumTest | Level1)
{
    int ret;
    off64_t offset = 0;
 ...
 * @tc.level  : Level 2
 */
HWTEST_F(HatsEnterTest, SpliceInvalidFdFailed_0003, Function | MediumTest | Level2)
{
    int ret;
    off64_t offset = 0;
    int pipeFd[2];
 ...
 * @tc.level  : Level 2
 */
HWTEST_F(HatsEnterTest, SpliceNoPipeFdFailed_0004, Function | MediumTest | Level2)
{
    int ret;
    off64_t offset = 0;
 ...
 * @tc.level  : Level 2
 */
HWTEST_F(HatsEnterTest, SplicePipeOffsetNotNullFailed_0005, Function | MediumTest | Level2)
{
    int ret;
    off64_t offset = 0;
    int pipeFd[2];
 ...
 * @tc.level  : Level 2
 */
HWTEST_F(HatsEnterTest, SpliceFdOpenAsAppendFailed_0006, Function | MediumTest | Level2)
{
    int ret;
    int pipeFd[2];
    off64_t offset = 0;
 ...
 * @tc.level  : Level 2
 */
HWTEST_F(HatsEnterTest, SpliceUseTheSamePipeFdFailed_0007, Function | MediumTest | Level2)
{
    int ret;
    int pipeFd[2];
